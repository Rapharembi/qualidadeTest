...
public class ProdutoTest {
	...
	@DisplayName("Testa produtos iguais")
	@Test
	...
	@DisplayName("Testa busca")
	@Test
	public void testBusca() {
		boolean busca = livro.equals(livro);
		Assertions.assertTrue(busca, "Nome não confere");
	}
